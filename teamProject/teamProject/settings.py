...
ALLOWED_HOSTS = ['0.0.0.0','127.0.0.1:8000','https://whereami.netsoc.cloud/','whereami.netsoc.cloud/','whereami.netsoc.cloud', '127.0.0.1','https://lostincork.ie','lostincork.ie']
...
DATABASES = {
    'default': {
        ...
        # 'NAME': BASE_DIR / 'db.sqlite3',  # This line causes PosixPath problems for me ( John )
